...
\begin{multicols*}{3}
  ...
  \subsection*{Wichtige Konstanten}
    \begin{itemize}
        ...
        \item Wien'sche Verschiebungskonstante (b) = \SI{2.8977729e-3}{m K}
  ...
  \begin{itemize}
    \item Intensität:
      \begin{equation*}
        I = \frac{P}{A} \quad \left[\frac{W}{m^2}\right]
      \end{equation*}
  ...
  \begin{itemize}
    \item Absorptionsgrad ($\alpha$): Absorbierte Strahlung
  ...
  \end{equation*}
  \begin{center}
    $b$: Wien'sche Verschiebungskonstante \(\left[ m K \right]\), \\
    $T$: absolute Temperatur \(\left[ K \right]\)
  \end{center}
